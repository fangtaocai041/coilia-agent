...
| v7.0 | 2026-06-19 | 自我评估改版 | 星级评分，结构化优势/局限/路线图 |
| v6.0 | 2026-06-18 | 生态图谱 | 添加完整 S-T-V-P₁-P₂ 图表，跨项目链接 |
| v5.0 | 2026-06-17 | v1.4.0 同步 | 分析脚本文档，144 测试，SpeciesRegistry 文档 |
| v4.0 | 2026-06-14 | 哲学章节 | 三谛，"何以重要"对比表 |
| v3.0 | 2026-06-10 | 架构深度解析 | 内部架构树，S-T-V-P₁-P₂ 角色 |
| v2.0 | 2026-06-05 | 快速入门充实 | CLI 示例，物种专属命令 |
| v1.0.0 | 2026-06-01 | 初稿 | 项目概述，基本结构，功能表 |
